...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 30 2018 г., 21:44
...
(14, '', '076e3caed758a1c18c91a0e9cae3368f.jpg', 'Chrysanthemum.jpg', 10),
...
(25, 'users', '$2y$10$MbDjZVUoLwVLiWvQ5mykY.m/nvbeFcZnmVSWpuwoc7yyVEPRAREgO', '', 'смсчм', 'чсмчсмс', 'мчсмчсмс', '564564', 'asd@vas.ru', 14, 'male', '', NULL, NULL, NULL, NULL, NULL, NULL),
(26, 'admin', '$2y$10$VpucOr66mxl2ZW/tNLDCwOUmaFFpnI5V2DugO3j99VMGOwdWd6xCa', 'йцукен', 'фывыв', 'ывыфв', 'ыфвыфв', '9225546231', 'asd@vas.ru', 14, 'male', 'йцукен', 'on', 'on', 'on', 'on', 'on', 'on');
...
--
ALTER TABLE `users_auth`
  MODIFY `id_user_session` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
